...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'SoccerStats.context_processors.competitions',
                'SoccerStats.context_processors.fixtures',
                'SoccerStats.context_processors.players',
                'SoccerStats.context_processors.tables',
                'SoccerStats.context_processors.teams',
            ],
        },
    },
]
