    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('SCHEDULED', 'Geplant'), ('TIMED', 'Festgelegt'), ('POSTPONED', 'Verschoben'), ('IN_PLAY', 'Im Spiel'), ('CANCELED', 'Abgebrochen'), ('FINISHED', 'Beendet'), ('FT', 'FT')], db_index=True, max_length=255, null=True)),
